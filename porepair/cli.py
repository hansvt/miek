...
def cmd_detect(args):
    ...
    i_reg = D.detect_regions_imm(imm_bgr, channel=args.imm_channel, region_mask=region_mask,
                                 ...
                                 pore_diam=(args.imm_pore_diam or None), thr_mult=args.imm_thr_mult)
...
def main(argv=None):
    ...
    d.add_argument("--imm-thr-mult", type=float, default=1.0, help="region: threshold multiplier (>1 drops faint noise)")
